...
const API_INPI = import.meta.env.VITE_API_URL + "/inpi/entreprise/"; // Ex: backend proxy pour INPI
const API_VIES = import.meta.env.VITE_VAT_API_URL + "/check-vat"; // Ex: backend proxy pour VIES

/**
 * Récupère et normalise toutes les données nécessaires pour un affichage à la Annuaire-Entreprises.
 */
